...
import (
	...
	"github.com/jaiprakash-singh/go-bookstore/pkg/models"
	"github.com/jaiprakash-singh/go-bookstore/pkg/utils"
...
func UpdateBook(w http.ResponseWriter, r *http.Request) {
	...
	ID, err := strconv.ParseInt(bookId, 0, 0)
	if err != nil {
		log.Fatal("Error parsing bookId while updating book")
	}
